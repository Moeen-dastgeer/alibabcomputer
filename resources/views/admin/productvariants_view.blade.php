<x-admin.app-layout>
    ...
    <x-slot name="contentHeader">
        <div class="col-sm-6">
            <h1 class="m-0">Product Variants</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ url('/admin/variants/create') }}" class="btn btn-sm btn-primary">
                        ...
                        @foreach ($variants as $variant)
                            <tr align="center">
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('/admin/variants/edit/') }}/{{ $variant->id }}"
    ...
    // }
            ...
            var page_url = "{{ url('/admin/variants/variants-ajax?') }}";
            // Pagination   
